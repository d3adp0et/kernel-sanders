...
#
# Components:
#   lkm/           Kernel rootkit module
#   exploit/       Privilege escalation programs
#   loader/        Reflective loader
#   shellcode/     Beachhead PIC shellcode
#   tools/         C2 helpers
#   drivers/       Vulnerable kernel drivers
#   service/       MERIDIAN TCP service
# Usage:
